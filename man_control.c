...
#define S_FUNCTION_NAME                man_control
...
extern void man_control_Outputs_wrapper(const real32_T *throttle,
...
{
  const real32_T *throttle = (real32_T *) ssGetInputPortRealSignal(S, 0);
  const real32_T *man_en = (real32_T *) ssGetInputPortRealSignal(S, 1);
  real32_T *Fd = (real32_T *) ssGetOutputPortRealSignal(S, 0);
  man_control_Outputs_wrapper(throttle, man_en, Fd);
}
