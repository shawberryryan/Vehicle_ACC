...
extern void model_Outputs_wrapper(const real32_T *u,
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
  ...
  const real32_T *L1 = (const real32_T *) mxGetData(PARAM_DEF0(S));
  const real32_T *L2 = (const real32_T *) mxGetData(PARAM_DEF1(S));
  model_Outputs_wrapper(u, delta, psi, xdot, ydot, psidot, L1, p_width0, L2,
                        p_width1);
}
