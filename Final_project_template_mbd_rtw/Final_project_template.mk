...
# LIBS =
#  
#  LIBS += libecatinterface.a.a 
#  LIBS += libEcMaster.a.a 
#  LIBS += libslrealtime_libsrc_pervar.a.a 
#  

# LIBS =
#  
#  LIBS += libecatinterface.a.lib 
#  LIBS += libEcMaster.a.lib 
#  LIBS += libslrealtime_libsrc_pervar.a.lib 
#  
...
###################################
%.o : N:\windat.V2\Desktop\EECS461_ryshaw\project/%.c
	@echo ### "N:\windat.V2\Desktop\EECS461_ryshaw\project\$*.c"o
    ifeq ($(TARGET_COMPILER), GreenHills Multi)
	$(CC) -c -MD $(CC_OPTS) $(CFLAGS) -o $@ $<
    else
	@$(CC) $(CC_OPTS) $(CFLAGS) $<
    endif
%.o : $(MATLAB_ROOT)\toolbox\slrealtime\simulink\blocks/%.c
	@echo ### "$(MATLAB_ROOT)\toolbox\slrealtime\simulink\blocks\$*.c"o
    ifeq ($(TARGET_COMPILER), GreenHills Multi)
	$(CC) -c -MD $(CC_OPTS) $(CFLAGS) -o $@ $<
    else
	@$(CC) $(CC_OPTS) $(CFLAGS) $<
