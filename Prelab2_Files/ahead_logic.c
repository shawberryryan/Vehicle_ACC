 ...
 *  -------------------------------------------------------------------------
 *
 * Created: Wed Apr 10 18:08:46 2024
 */

#define S_FUNCTION_LEVEL               2
#define S_FUNCTION_NAME                ahead_logic
...
#define INPUT_0_DIMS_ND                {28,1}
#define INPUT_0_NUM_ELEMS              28
#define INPUT_0_WIDTH                  28
...
extern void ahead_logic_Outputs_wrapper(const real32_T *u,
  real32_T *s_out,
  real32_T *us_out);
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
  ...
  real32_T *s_out = (real32_T *) ssGetOutputPortRealSignal(S, 0);
  real32_T *us_out = (real32_T *) ssGetOutputPortRealSignal(S, 1);
  ahead_logic_Outputs_wrapper(u, s_out, us_out);
}
