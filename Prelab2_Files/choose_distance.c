 ...
 *  -------------------------------------------------------------------------
 *
 * Created: Wed Apr 10 17:58:47 2024
 */

#define S_FUNCTION_LEVEL               2
#define S_FUNCTION_NAME                choose_distance
...
#define INPUT_1_DIMS_ND                {7,1}
#define INPUT_1_NUM_ELEMS              7
...
extern void choose_distance_Outputs_wrapper(const real32_T *u0,
  const real32_T *u1,
  real32_T *y0,
  real32_T *y1);
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
  ...
  real32_T *y1 = (real32_T *) ssGetOutputPortRealSignal(S, 1);
  choose_distance_Outputs_wrapper(u0, u1, y0, y1);
}
